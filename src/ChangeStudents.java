...
public class ChangeStudents {

    public void createStudents(String sql, Connection con){
    ...
    public void updateStudents(String sql, Connection con){
    ...
    public void deleteStudents(String sql, Connection con){
    ...
    public List<Students> getStudent(){return new ArrayList<>();}
}
