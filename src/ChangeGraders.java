...
public class ChangeGraders {

    public void createGraders(String sql, Connection con){
    ...
    public void updateGraders(String sql, Connection con){
    ...
    public void deleteGraders(String sql, Connection con){
    ...
    public List<Students> getGraders(){return new ArrayList<>();}
}
